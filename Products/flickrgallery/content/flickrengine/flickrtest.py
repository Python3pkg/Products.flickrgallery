...
def showphotos( tags="" ):
    ...
    for photo in photos['photo']:
        ...
        photourl = "http://farm%s.static.flickr.com/%s/%s_%s.jpg" % (farm,server,photo['id'],photo_secret)
        photourl_medium = "http://farm%s.static.flickr.com/%s/%s_%s_m.jpg" % (farm,server,photo['id'],photo_secret)
        photourl_small = "http://farm%s.static.flickr.com/%s/%s_%s_s.jpg" % (farm,server,photo['id'],photo_secret)
